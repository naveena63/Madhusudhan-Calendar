...
import zastrait.GSTIT.BottomNavigtnActivity;
import zastrait.GSTIT.ColorsDropDownMycalendar;
...
public class MyCalendarFormActivity extends AppCompatActivity {

    EditText eteventName, etDescrption;
    public CustomTextViewNormal tveventDate, buttonShowDropDown;
    MyCalendarFragment myCalendarFragment;
    ...
    String col;
    String blue = String.valueOf(Color.BLACK);
    int color = Color.parseColor("#519c3f");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_calendar_form);
        context = MyCalendarFormActivity.this;
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyCalendarFormActivity.this, BottomNavigtnActivity.class);
    ...
    public PopupWindow popupWindowColors() {
        ...
        listViewDogs.setOnItemClickListener(new ColorsDropDownMycalendar());
    ...
    private ArrayAdapter<String> dogsAdapter(String dogsArray[]) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, dogsArray) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                String id = itemArr[0];
                TextView listItem = new TextView(MyCalendarFormActivity.this);
    ...
    private void getForm() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConstants.BASE_URL + AppConstants.postuserevent,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("true")) {
                                ...
                                Toast.makeText(MyCalendarFormActivity.this, "Success", Toast.LENGTH_SHORT).show();

//                                Intent i=new Intent(MyCalendarFormActivity.this,BottomNavigtnActivity.class);
//                                i.putExtra("session", "1");
                                onBackPressed();
//                                startActivity(i);

                            } else if (status.equals("false")) {
                                Toast.makeText(MyCalendarFormActivity.this, message, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        Log.i("Registration", "--------------Registration Response----------------" + response);
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MyCalendarFormActivity.this, "couldn't find Network", Toast.LENGTH_LONG).show();
